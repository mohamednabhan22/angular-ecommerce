...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-admin-admin-module"], {
  ...
  /***/
  function srcAppComponentsAdminAddProductAddProductComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    function AddProductComponent_div_7_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function AddProductComponent_option_18_Template(rf, ctx) {
      if (rf & 1) {
    ...
    function () {
      ...
      _createClass(AddProductComponent, [{
        ...
        value: function addProduct(form) {
          ...
          this.subscription = this.productService.addProduct(name, price, description, category, file).subscribe(function (res) {
            console.log(res);
    ...
    AddProductComponent.ɵfac = function AddProductComponent_Factory(t) {
      return new (t || AddProductComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_products_products_service__WEBPACK_IMPORTED_MODULE_1__["productService"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]));
    };
    ...
    AddProductComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 22,
      vars: 5,
      consts: [[1, "container", "text-center", "product", 2, "margin-top", "200px"], [1, "my-5"], ["enctype", "multipart/form-data", 3, "ngSubmit"], ["Form", "ngForm"], ["ngModel", "", "type", "name", "name", "name", "placeholder", "name  ", "required", "", 1, "form-control", "mb-3"], ["name", "ngModel"], ["class", "alert alert-danger", 4, "ngIf"], ["ngModel", "", "type", "number", "name", "price", "placeholder", "Price", "required", "", 1, "form-control", "mb-3"], ["price", "ngModel"], ["ngModel", "", "type", "text", "name", "description", "placeholder", "Description", "required", "", 1, "form-control", "mb-3"], ["description", "ngModel"], ["ngModel", "", "name", "category", "required", "", 1, "form-control", "mb-3"], ["category", "ngModel"], ["value", "", "selected", ""], [3, "value", 4, "ngFor", "ngForOf"], ["ngModel", "", "type", "file", "name", "img", "placeholder", "Image", 1, "form-control", 3, "change"], ["type", "submit", "value", "Add Product", 1, "btn", "btn-primary", "m-5"], [1, "alert", "alert-danger"], [3, "value"]],
      template: function AddProductComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function AddProductComponent_Template_form_ngSubmit_3_listener() {
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r45);

            var _r34 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](4);

            return ctx.addProduct(_r34);
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("change", function AddProductComponent_Template_input_change_20_listener($event) {
        ...
        if (rf & 2) {
          ...
          var _r41 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵreference"](15);
  ...
  function srcAppComponentsAdminAdminRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _add_product_add_product_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    ...
    var routes = [{
      path: "",
      component: _add_product_add_product_component__WEBPACK_IMPORTED_MODULE_0__["AddProductComponent"]
    }];
    ...
    addProductRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineNgModule"]({
      type: addProductRoutingModule
    });
    addProductRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵdefineInjector"]({
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](addProductRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵsetClassMetadata"](addProductRoutingModule, [{
  ...
  function srcAppComponentsAdminAdminModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    adminModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineInjector"]({
      ...
      imports: [[_shared_shared_module__WEBPACK_IMPORTED_MODULE_0__["sharedModule"], _admin_routing_module__WEBPACK_IMPORTED_MODULE_1__["addProductRoutingModule"]]]
    });
